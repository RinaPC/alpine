...
```
apk add nano nano-syntax e2fsprogs dosfstools mesa-dri-gallium mesa-va-gallium intel-media-driver dbus fastfetch lm-sensors btop openssh-client-default openssh-keygen 
apk add sway seatd foot pipewire pipewire-alsa wireplumber mpv firefox fcitx5-hangul wofi swaybg swayidle swaylock font-dejavu font-awesome adwaita-icon-theme
